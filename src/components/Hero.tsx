...
export default function Hero() {
  return (
    <section className="relative min-h-[680px] px-4 sm:px-6 lg:px-8 text-white overflow-hidden">
      <img
        src={europeNight}
        alt=""
      ...
      <div className="relative z-10 max-w-7xl mx-auto min-h-[680px] flex flex-col justify-center text-center">
        <p className="text-sm font-semibold uppercase tracking-[0.2em] text-gray-300 mb-5">
          GeoVision
        </p>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          ...
          <a
            href="#contact"
            className="inline-flex items-center justify-center px-8 py-3 bg-transparent text-white font-medium rounded-lg border border-white/50 hover:bg-white/10 transition-colors"
          >
            Contact
          </a>
        </div>
